...
//		 Runtime.getRuntime().exec("cmd /c start cmd.exe /K \"cd C:/Users/Utente/Desktop/CEA && @echo Combustion2|FCEA2 && exit\""); 
		...
		RunMultyCea p1 = new RunMultyCea("cmd /c start cmd.exe /K \"cd C:/Users/Utente/Desktop/CEA && @echo Combustion|FCEA2 && @echo Combustion2|FCEA2 && @echo Combustion3|FCEA2 && exit\"");
